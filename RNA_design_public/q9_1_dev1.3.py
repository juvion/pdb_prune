...
if __name__ == "__main__":
    ...
    for i, split_seed in enumerate(split_seeds):
        ...
        results_df.to_csv('qcbm_rna_results_q9_1_dev1.3_qbits8.csv', index=False)
        print(f"Results updated and saved to qcbm_rna_results_q9_1_dev1.3_qbits8.csv")
    ...
    results_df.to_csv('qcbm_rna_results_q9_1_dev1.3_qbits8.csv', index=False)
    print(f"\nResults saved to qcbm_rna_results_q9_1_dev1.3_qbits8.csv")
