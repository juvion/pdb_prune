...
class PDBParser:
    """Parse PDB files and extract nucleotide information"""
    ...
    def parse(filename: str) -> List[Nucleotide]:
        """Parse PDB file and return list of nucleotides"""
        nucleotides_dict = {}
                ...
                if line.startswith('ATOM') or line.startswith('HETATM'):
                    try:
                        ...
                        if residue_name in ["ADE", "rA", "DA"]:
                            ...
                            residue_name = "U"  # Treat thymine as uracil for RNA
        ...
        # Convert to list and sort by chain and residue number
...
class BasePairDetector:
    ...
    def is_base_paired(nuc1: Nucleotide, nuc2: Nucleotide, 
        ...
        if require_coplanarity and not BasePairDetector.check_coplanarity(nuc1, nuc2):
            return False
        ...
        # Require at least 2 H-bonds for a base pair
